...
const examsData = [
    ...
    },
    {
        ...
        invigilator: "Test Center Staff",
        instructions: "Bring your passport and confirmation email.  No electronic devices allowed.",
    },
    {
        title: "SAT",
...
const Exams = () => {
  return (
      <div className="px-16 py-4 mt-8">
          <h1 className='text-4xl font-bold text-red-400 text-center'>Entrance exams</h1> 
        <ExamsGrid />
      </div>
  )
}
...
const ExamsGrid =()=>{
    return(
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-2"> 
           {examsData.map((exam)=>(
               <div key={exam.title} className="bg-gray-100 rounded-lg h-96 shadow-md overflow-hidden">
                   <img
